            ...
            <form onSubmit={handleAddPost} className="space-y-6">
              ...
              <div className="space-y-4">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <input  type="number" value={newPost.stock} className="w-full bg-slate-50 border-2 border-transparent focus:border-blue-500 rounded-2xl p-4 outline-none font-bold transition-all" placeholder="Stock Qty" onChange={(e) => setNewPost({ ...newPost, stock: e.target.value })} />
                </div>
